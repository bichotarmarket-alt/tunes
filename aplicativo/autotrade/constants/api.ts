...
export const API_CONFIG = {
  // Backend URL - será detectado automaticamente via ngrok
  // Se ngrok não estiver disponível, app não funcionará
  BASE_URL: '', // Será substituído pelo URL do ngrok
  API_PREFIX: '/api/v1',

  // URLs locais para detecção automática
  LOCAL_URLS: [
