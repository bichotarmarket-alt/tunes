"""
Correção dos novos indicadores para seguir o padrão dos indicadores originais

Os indicadores originais (RSI, MACD, Stochastic) têm:
1. calculate() retorna apenas valores calculados (Series ou tupla)
2. calculate_with_signals() retorna DataFrame completo com sinais, confiança, divergência

Os novos indicadores precisam ser corrigidos para seguir este padrão.
"""
...
class ParabolicSAR(TechnicalIndicator):
    """Parabolic SAR indicator - CORRIGIDO para seguir padrão dos indicadores originais"""
